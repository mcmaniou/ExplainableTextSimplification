...
# Define some key variables that will be used later
train_batch_size = 8
valid_batch_size = 8
max_epochs = 20
data_filepath = "gdrive/MyDrive/thesis_data/sentences_data.csv"
output_dir = "gdrive/MyDrive/thesis_data/models/model"
...
# Fine-tune the model for the specific task
model = DistilBertForSequenceClassification.from_pretrained("distilbert-base-uncased-finetuned-sst-2-english", num_labels=2) #"distilbert-base-uncased")
